            ...
            <span class="icon-bar"></span>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right custom-menu">
                        ...
                        <li class="active"><a href="book_request.php">Book Requests</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <?php
                      $numberOfOrder = 0;
                      include("../connect.php");
                      $s = "SELECT count(id) as num from book_order NATURAL JOIN  book where owner_id = '$s_id' ";
                      $r = $conn->query($s);
                    ...
                    <table >   -->
                      ...
                      if(isset($_POST['acceptBook'])){
                        ...
                        $sql = "UPDATE `book_order` SET `except`= 1 WHERE  book_id = '".$_POST['book_id']."'";
                        $res = $conn->query($sql);
                    ...
                    ?>
                        ...
                        //books show
                        //$i = 0;
                        $sqlBook = "SELECT * FROM book_order NATURAL JOIN book where owner_id = '$s_id'";
                       ...
                       <div class='col-sm-4 col-md-4 '>
                        ...
                        <br>
                            ...
                            <form method='post' action = ''>
                              <div >
                                <input type='submit' class='buttonCustom buttonCustom2' name= 'acceptBook' value='Approve It'/>
                                <input type='hidden' name='book_id' value='".$rowB['id']."'/>
                              </div>
                            </form></p>
                        </div>
