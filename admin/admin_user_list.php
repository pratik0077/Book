...
<body data-spy="scroll">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  <ul class="nav navbar-nav navbar-right custom-menu">
                        ...
                        <li class="active"><a href="admin_user_list.php">User list</a></li>
    ...
    <section>
        ...
        <form action="" method="POST">
			<input type="text" name="user_input" placeholder="search by name">
			<input type="submit" name="name_search" value="search">
            
			<input type="text" name="id_input" placeholder="search by ID">
			<input type="submit" name="id_search" value="search">
			<input type="text" name="email_input" placeholder="search by email">
			<input type="submit" name="email_search" value="search">
			<input type="text" name="password_input" placeholder="search by password">
			<input type="submit" name="pass_search" value="search">
			<input type="text" name="type_input" placeholder="search by type">
			<input type="submit" name="type_search" value="search"><br>
        </form>
        </div>
        <div id="table_div">
            <table >
