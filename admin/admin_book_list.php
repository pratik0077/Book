            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  <ul class="nav navbar-nav navbar-right custom-menu">
                        ...
                        <li class="active"><a href="admin_book_list.php">List of Books</a></li>
    ...
    <section class="container blog">
        ...
        <div id="book">
            ...
            <?php
                ...
                $query="SELECT * FROM book where title like '%$key%' or ISBN like '%$key%' or quantity like '%$key%' or price like '%$key%' or status like '%$key%' or edition like '%$key%' or owner_id like '%$key%'";
